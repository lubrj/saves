...
Set-ItemProperty -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System" -Name "EnableLUA" -Value 0if (-not ([System.Management.Automation.PSTypeName]'InputBlocker').Type) {
    Add-Type @"
using System;
